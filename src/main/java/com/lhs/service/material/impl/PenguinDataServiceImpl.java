...
import com.lhs.entity.dto.material.OtherItemDropDTO;
...
@Service
public class PenguinDataServiceImpl implements PenguinDataService {
     private final StageService stageService;

    public PenguinDataServiceImpl(StageService stageService) {
    ...
    public Map<String, List<StageDropAndInfoDTO>> getStageDropCollect(ItemValueConfigDTO itemValueConfigDTO) {
        ...
        for (Map.Entry<String, StageDropAndInfoDTO> entry : ytlStageDataGroupByItemId.entrySet()) {
            ...
            if (dropInfo.getTimes() > 0) {
                ...
                StageDropAndInfoDTO lmdDrop = createDropTemplate(dropInfo, lmdItem);
...
/**
     ...
     * @return 关卡掉落与信息DTO
     */
    public static StageDropAndInfoDTO createDropTemplate(StageDropAndInfoDTO stageInfo, OtherItemDropDTO shopRedemptionItem) {
        ...
        dto.setEnd(System.currentTimeMillis()+1000*60*60*24*30);
