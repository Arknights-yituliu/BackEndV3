...
//        Long incrId = redisTemplate.opsForValue().increment("SurveyID");   //从redis拿到自增id
        ...
        String idStr = date.getTime()+ConfigUtil.MachineId+randomEnd4_id();
        ...
        hashMap.put("token", AES.encrypt(surveyUser.getUserName()+"."+id,ConfigUtil.Secret));
    ...
    public HashMap<Object, Object> login(String ipAddress, String userName) {
        ...
        hashMap.put("token", AES.encrypt(userName+"."+surveyUser.getId(),ConfigUtil.Secret));
    ...
    public JSONObject getCharacterTable(){
        String read = FileUtil.read(ConfigUtil.Backup + "character_table_simple.json");
