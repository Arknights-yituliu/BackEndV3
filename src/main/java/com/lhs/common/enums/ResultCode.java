...
public enum ResultCode {
	...
	ROGUE_SEED_IS_NULL_OR_FORMAT_ERROR(30003, "肉鸽种子未填写或格式不正确"),
	ROGUE_SEED_TYPE_IS_NULL_OR_ERROR(30004, "种子类型未选择或类型错误"),
	ROGUE_SEED_PARAMS_IS_NULL(30005, "肉鸽种子表单未填写完整"),
	ROGUE_SEED_RATING_ERROR(30006, "肉鸽种子评价错误"),
	ROGUE_SEED_DESCRIPTION_LONGER_THAN_200_CHARACTERS(30007, "肉鸽种子描述超出200字"),
	ROGUE_SEED_DESCRIPTION_LESS_THAN_8_CHARACTERS(30008, "肉鸽种子描述少于8字"),
	ROGUE_SEED_COUNT_LESS_THAN_10(30009, "当前可roll种子总数小于10"),
