...
public enum ResultCode {
	...
	VERIFICATION_CODE_NOT_EXIST(39002, "验证码不存在或已过期"),
	VERIFICATION_CODE_NOT_SEND(39003, "验证码未发送"),
	OSS_UPLOAD_ERROR(39004, "OSS上传错误"),
	EMAIL_SENT_TOO_FREQUENTLY(39005,"邮件发送间隔时间30秒"),
	NOT_REPEAT_REQUESTS(39006,"不要重复请求"),
