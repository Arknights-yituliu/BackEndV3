...
public class JsonMapper {
    ...
    public static <T> T parseObject(String jsonString, Class<T> object) {
        ...
        try {
            ...
            LogUtil.error("JsonString转为自定义对象失败：{}"+ e.getMessage());
        }
        return t;
    }
    ...
    public static <T> T parseObject(File file, Class<T> object) {
        ...
        try {
            ...
            LogUtil.error("从文件中读取json字符串转为自定义对象失败：{}"+ e.getMessage());
        }
        return t;
    }
    ...
    public static <T> T parseJSONArray(String jsonArray, TypeReference<T> reference) {
        ...
        try {
            ...
            LogUtil.error("JSONArray转为List列表或者Map集合失败，转换类型为"+reference.getClass().getName()+"{}"+e.getMessage());
        }
        return t;
    }
    ...
    public static String toJSONString(Object object) {
        ...
        try {
            ...
            LogUtil.error("Object转JSONString失败：{}"+ e.getMessage());
        }
        return jsonString;
    }
    ...
    public static byte[] toByteArray(Object object) {
        ...
        try {
            ...
            LogUtil.error("Object转ByteArray失败：{}"+ e.getMessage());
        }
        return bytes;
    }
    ...
    public static void objectToFile(File file, Object object) {
        try {
            ...
            LogUtil.error("Object写入文件失败：{}"+ e.getMessage());
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public static JsonNode parseJSONObject(String jsonString) {
        ...
        try {
            ...
            LogUtil.error("JSONString转为JsonNode失败：{}"+ e.getMessage());
        }
        return jsonNode;
    }
    ...
    public static String toJSONString(JsonNode jsonNode) {
        ...
        try {
            ...
            LogUtil.error("JsonNode转JSONString失败：{}"+ e.getMessage());
        }
        return jsonString;
    }
